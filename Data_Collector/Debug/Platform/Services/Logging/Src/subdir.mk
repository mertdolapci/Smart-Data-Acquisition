...
C_SRCS += \
../Platform/Services/Logging/Src/svc_log.c 

OBJS += \
./Platform/Services/Logging/Src/svc_log.o 

C_DEPS += \
./Platform/Services/Logging/Src/svc_log.d 


# Each subdirectory must supply rules for building sources it contributes
Platform/Services/Logging/Src/%.o Platform/Services/Logging/Src/%.su Platform/Services/Logging/Src/%.cyclo: ../Platform/Services/Logging/Src/%.c Platform/Services/Logging/Src/subdir.mk
...
clean: clean-Platform-2f-Services-2f-Logging-2f-Src

clean-Platform-2f-Services-2f-Logging-2f-Src:
	-$(RM) ./Platform/Services/Logging/Src/svc_log.cyclo ./Platform/Services/Logging/Src/svc_log.d ./Platform/Services/Logging/Src/svc_log.o ./Platform/Services/Logging/Src/svc_log.su

.PHONY: clean-Platform-2f-Services-2f-Logging-2f-Src
